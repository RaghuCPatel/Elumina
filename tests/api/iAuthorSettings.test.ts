...
test("Admin_477. @API Admin fetch the tags-filters-information", async ({ request }) => {
...
test("Admin_478. @API Endpoint validation for tags-filters  information", async ({ request }) => {
...
test("Admin_479. @API Access token validation for tags-filters_information", async ({ request }) => {
...
test("Admin_480. @API Admin  tags-filters-Header field validation - invalid", async ({ request }) => {
...
test("Admin_488. @API Admin Edit the question-type-update information", async ({ request }) => {
...
test("Admin_489. @API Admin Edit the question-type-update _validation of incorrect HTTP method", async ({ request }) => {
...
test("Admin_490. @API Admin Edit the question-type-update _validation of invalid endpoint", async ({ request }) => {
...
// test("Admin_518. @API Admin add  thequestion-type-duplicate-save  of incorrect HTTP method", async ({ request }) => {
...
test("Admin_484. @API Admin fetch the tags-filters-information", async ({ request }) => {
...
test("Admin_485. @API Endpoint validation for tags-filters  information", async ({ request }) => {
...
test("Admin_486. @API Access token validation for tags-filters_information", async ({ request }) => {
...
test("Admin_487. @API Admin  tags-filters-Header field validation - invalid", async ({ request }) => {
...
// test("Admin_494. @API Admin fetch the tags-filters-information", async ({ request }) => {

//     jsonpath = JSON.parse(fs.readFileSync(path.resolve('utils/api/adminCredential.json'), 'utf-8'))
//     jschemasonpath = JSON.parse(fs.readFileSync(path.resolve('utils/schema/iAuthorSchema.json'), 'utf-8'))
//     verifyResponse.fetchrequestTime();
//     const response = await request.get(baseURL + '/question-type-filter',
//         {
...
// test("Admin_495. @API Endpoint validation for tags-filters  information", async ({ request }) => {

//     jsonpath = JSON.parse(fs.readFileSync(path.resolve('utils/api/adminCredential.json'), 'utf-8'))
//     jschemasonpath = JSON.parse(fs.readFileSync(path.resolve('utils/schema/iAuthorSchema.json'), 'utf-8'))
//     verifyResponse.fetchrequestTime();
//     const response = await request.get(baseURL + '/question-type-filterIGS',
//         {
//            // data: jsonpath.adminLogin.body,
//             headers: {
//                 "accept": "application/json",
...
// test("Admin_496. @API Access token validation for tags-filters_information", async ({ request }) => {
...
// test("Admin_497. @API Admin  tags-filters-Header field validation - invalid", async ({ request }) => {
...
test("Admin_513. @API Admin fetch the tags-filters-information", async ({ request }) => {
...
test("Admin_514. @API Endpoint validation for tags-filters  information", async ({ request }) => {

    jsonpath = JSON.parse(fs.readFileSync(path.resolve('utils/api/adminCredential.json'), 'utf-8'))
    jschemasonpath = JSON.parse(fs.readFileSync(path.resolve('utils/schema/iAuthorSchema.json'), 'utf-8'))
    verifyResponse.fetchrequestTime();
    const response = await request.get(baseURL + '/admin-api/v1/question-type/4/IGS',
        {
           // data: jsonpath.adminLogin.body,
            headers: {
                "accept": "application/json",
...
test("Admin_515. @API Access token validation for tags-filters_information", async ({ request }) => {
...
test("Admin_516. @API Admin  tags-filters-Header field validation - invalid", async ({ request }) => {
