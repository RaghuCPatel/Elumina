...
test(` . @iProctorRegression Validation of Candidate > Peripheral verification > Allow Mic`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
