...
test(`@Regression1 Validation of Changing Font Size to increase on the Dashboard `, async ({ eluminaProctorCand, webActions }) => {
    ...
    await test.step('Candidate start the exam', async () => {
        ...
        await eluminaProctorCand.increaseFontSize();
    });
});