...
test(`@Regression Validation of Proctoring Exam Events > Exam Resumed`, async ({ eluminaCandPage,eluminaLoginPage,eluminaProctorCand,eluminaProctorReg,webActions }) => {
