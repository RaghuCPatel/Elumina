...
test(`@Regression1 Validation of Proctoring Exam Events > Exam Resumed`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
