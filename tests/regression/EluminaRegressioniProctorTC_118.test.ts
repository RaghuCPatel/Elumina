...
test(` iProc_TC_ID_112. @iProctorRegression Validation of Internet Connection Verified`, async ({ eluminaProctorCand, eluminaLoginPage, eluminaProctorReg, webActions }) => {
