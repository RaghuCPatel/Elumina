...
test(` . @iProctorRegression Validation of Proctoring Exam > Completed`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
