...
test(` . @iProctorRegression Validation of Proctoring Completed Exam candidate > Complete user journey events validation.`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorExam, eluminaProctorCand, eluminaProctorReg, webActions }) => {
