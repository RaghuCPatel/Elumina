...
test(` . @iExamSerialRegression Validation of invigilator remotely start the Exam for candidate EluminaRegressioniExamTC_086`, async ({ eluminaCandPage, eluminaCadInvPage, eluminaProctorCand, webActions }) => {
