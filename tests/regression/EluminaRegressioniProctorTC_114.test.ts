...
test(`@Regression1 Validation of Proctoring Exam Event with Login Success`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
