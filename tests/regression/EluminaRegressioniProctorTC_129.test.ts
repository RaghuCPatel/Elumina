...
test(`@Regression1 Validation of Proctoring Exam Events > Exam Interrupted`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
