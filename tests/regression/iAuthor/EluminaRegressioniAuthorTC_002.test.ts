...
test(`iAU_TC_ID_02. @RegressionA Validation of Client Logo and name, color, font size and font type of different elements in the login page`, async ({ eluminaLoginPage, webActions }) => {
