...
test(`[T2784] @RegressionA1 Validation of Client Logo and name, color, font size and font type of different elements in the login page`, async ({ eluminaLoginPage, webActions }) => {
