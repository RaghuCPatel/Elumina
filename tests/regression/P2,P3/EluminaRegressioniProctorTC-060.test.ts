...
test(`@RegressioniP Validation of Proctoring Exam > Traffic light Green`, async ({ eluminaCandPage,eluminaLoginPage,eluminaProctorCand,eluminaProctorReg,webActions }) => {
