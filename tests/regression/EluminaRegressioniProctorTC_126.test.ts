...
//Validation of Proctoring Exam Events > Status > Exam Paused

test(` iProc_TC_ID_120. @iProctorRegression Validation of Proctoring Exam Events > Status > Exam Paused`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
