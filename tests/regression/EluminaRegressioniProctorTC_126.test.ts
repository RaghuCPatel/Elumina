...
test(`@Regression Validation of Proctoring Exam Events > Status > Exam Paused`, async ({ eluminaCandPage,eluminaLoginPage,eluminaProctorCand,eluminaProctorReg,webActions }) => {
