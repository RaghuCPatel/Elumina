...
test(`@Regression1 Validation of Proctoring Exam Events > Status > Exam Paused`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
