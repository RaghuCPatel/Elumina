...
//Validation of Proctoring Exam > Fragment streaming.

test(` iProc_TC_ID_133. @iProctorRegression Validation of Proctoring Exam > Fragment streaming.`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
