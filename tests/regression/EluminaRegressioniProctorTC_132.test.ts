...
test(` iProc_TC_ID_126. @iProctorRegression Validation of Proctoring Exam Events > No Face Detected`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
