...
test(`@Regression1 Validation of Proctoring Exam Events > No Face Detected`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
