...
test(` . @iProctorRegression Validation of Proctoring Exam > Live streaming.`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
