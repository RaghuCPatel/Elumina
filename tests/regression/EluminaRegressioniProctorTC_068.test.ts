...
/**Validation of "Mark Attendance" (All Candidates) */


/*test(` . @iProctorRegression Validation of "Mark Attendance" (All Candidates)`, async ({ eluminaLoginPage, eluminaProctorExam, webActions }) => {
...
test(` . @iProctorRegression Validation of marking all attendance`, async ({ eluminaProctorCand, webActions }) => {
