...
test(` . @iProctorRegression Validation of Validation of Screen Capture verification check done`, async ({ eluminaCandPage, eluminaLoginPage, eluminaProctorCand, eluminaProctorReg, webActions }) => {
